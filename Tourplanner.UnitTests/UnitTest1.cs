...
//            routeManager.Setup(t => t.GetFullRoute("TestFromNew", "TestToNew", TransportType.Fastest, It.IsAny<Guid>())).ReturnsAsync(nullRoute);
//            tourDAO.Setup(t => t.UpdateTourById(It.IsAny<Tour>())).Returns(true);
//            calcA.Setup(t => t.CalculateChildFriendly(It.IsAny<IEnumerable<Log>>(), It.IsAny<double>())).Returns(true);
//            calcA.Setup(t => t.CalculatePopularity(It.IsAny<IEnumerable<Log>>())).Returns(PopularityEnum.Good);
...
//            routeManager.Setup(t => t.GetFullRoute(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TransportType>(), It.IsAny<Guid>())).ReturnsAsync(tryRoute);
